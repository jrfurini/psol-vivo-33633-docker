...
export default function Home() {
  ...
  const filteredClients = clients.filter((client) => {
    ...
    const matchCNPJ =
      !searchCNPJ || client.cnpj.includes(searchCNPJ.replace(/\D/g, ""));
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="grid grid-cols-6 items-center justify-between gap-4">
            <div className="col-span-1">
              <LogoVivo className="h-14 text-[#660099]" />
            </div>
              ...
              <DialogContent>
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    disabled={
                      !newQuoteData.salesforce || !newQuoteData.nomeProjeto
                    }
                  >
                    Criar
                  </Button>
