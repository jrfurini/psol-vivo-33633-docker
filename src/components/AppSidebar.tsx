import { FileText, Package, Users, Settings, LayoutGrid, DollarSign, FileSpreadsheet } from 'lucide-react';
...
const menuItems = [
  ...
  { title: 'Resumo Financeiro', url: '/resumo-financeiro', icon: FileSpreadsheet },
